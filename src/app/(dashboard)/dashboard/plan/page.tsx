  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12">
        ...
        {/* 竹プラン */}
        <div className="bg-gradient-to-b from-blue-50 to-purple-50 rounded-2xl shadow-xl p-8 border-2 border-blue-500 relative transform hover:scale-105 transition-transform">
          ...
          <button className="w-full py-3 px-6 bg-gradient-to-r from-blue-500 to-purple-500 text-white rounded-lg font-medium hover:opacity-90 transition-opacity">
            アップグレード
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 hover:shadow-xl transition-shadow">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 mb-4">大規模チーム向け</p>
            <div className="mb-6">
